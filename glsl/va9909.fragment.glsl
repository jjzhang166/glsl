//So this is how a block hole looks like ?
//Very impressive! Well done boy!
// Chaeris wrote that....
...
MapResult map_torus(vec3 position)
{
	...
	//This is the place with the only real bit of novel code; the rest is just a serving as a visualization framework 
	//what you see currently isnt the goal, but it was really late and so I just started messing around and it's cool looking (go home math, you're drunk)
	
	//ultimately, I want to make a coil of sorts
