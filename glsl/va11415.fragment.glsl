...
void CalcPixelRandom()
{
	...
	vec4 s1 = sin(time * 3.22 + gl_FragCoord.xxxx * vec4(4.324234, 3.324234, 7.324234, 4.324234)) * 543.3423;
	vec4 s2 = sin(time * 1.3422 + gl_FragCoord.yyyy * vec4(7.324234, 5.324234, 2.324234, 7.324234)) * 654.5423;
...
{           
	...
	float fNdotH = max(0.5, dot(vHalf, vNormal));
