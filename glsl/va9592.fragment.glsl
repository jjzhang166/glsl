// DIFFERENCE FROM PARENT: I *greatly* increased the curve, so as to make it a threshold. to look good you're going to have to turn the pixel-quality to 1 or 0.5.
...
void main( void ) {
	...
	for(float i = 1.;i <= 8.;i++)
	{
		...
		shell = smoothstep(0.5,0.50001,shell);
