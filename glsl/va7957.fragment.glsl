...
void checkIntersection(Ray ray, inout Intersection intersection) { 
  Sphere sphere0 = Sphere(vec3(-0.5 + 0.1 * sin(time), 0.3 * cos(time), 3.0 + 0.3 * sin(time)),
   0.5, vec4(1.0, 0.5, 0.5, 0.0), 2);
  ...
  Sphere sphere8 = Sphere(vec3(0.7, 0.5, 3), 0.5, vec4(1.0, 0.0, 1.0, 0.0), 3);
