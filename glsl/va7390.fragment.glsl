...
//
// experiments and modifications by @thismatt 
...
{          
	...
	vSphereDomain.y=cos(vSphereDomain.y)+cos(tt);


	vec4 vDistSphere = vec4( length(length(vSphereDomain))-mix(0.0,0.3,mouse.x)-sin(oP-tt*4.0), 2.0, vSphereDomain.xy);
