...
void main( void ) {
	...
	col = mix( col, vec3(0.1,1.0,0.0), distSmooth );
	...
	vec3 white = vec3(1.0);
	col = mix( col, white, circle(p.x+0.2, p.y+0.2, 0.25, 0.05) );
	col = mix( col, white, circle(p.x-0.2, p.y-0.2, 0.25, 0.05) );
	col = mix( col, white, circle(p.x+0.2, p.y-0.2, 0.35, 0.05) );
	col = mix( col, white, circle(p.x-0.2, p.y+0.2, 0.35, 0.05) );
	col = mix( col, white, circle(p.x-0.5+cos(time)*0.1, p.y+0.5+sin(time)*0.1, 0.1, 0.05) );
	col = mix( col, white, circle(p.x+0.5+sin(-time)*0.1, p.y-0.5+cos(-time)*0.1, 0.1, 0.05) );
	col = mix( col, vec3(1.0, 0.0, 0.0), circle(p.x+sin(time)*0.75, p.y+cos(time)*0.75, 0.05, 0.05) );
	col = mix( col, vec3(0.0), circle(p.x, p.y, 0.35, 0.05) );
	col = mix( col, vec3(0.8,0.5,0.0), rect(p.x+0.8, p.y, 0.2, 0.2, 0.05) );
