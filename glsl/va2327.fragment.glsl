...
//2012.04.27 bqqbarbhg fork: make some perspective effects
...
void main( void ) {
	...
	p /= vec2(0.5) - p + vec2( cos(time + p.x* 3.0) * 0.2  + 0.4, cos(time - p.y * 3.0) * 0.2 + 0.4);
	p -=  vec2(0.2) + vec2(sin(time * 0.3), cos(time * 0.5)) * 0.1;
