...
#define PACMAN_BACKGROUND_COLOR  vec4(1,2,1,9) 
#define BALL_COLOR vec4(1,1,0,1)

#define NUMBER_BALLS 8.0
#define BALL_RADIUS 0.03

#define LIGTH_POSITION vec2(-0.3)
 
#define ANIM_SPEED 6.0
 
#define MOUTH_ANGLE 45.0
...
void  draw_ball(float ball_num, vec2 position)
{
	...
	{
		float t = smoothstep(BALL_RADIUS+PACMAN_BORDER/2.0, BALL_RADIUS-PACMAN_BORDER/4.0, _ball_radius_distance);
