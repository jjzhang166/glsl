...
void main( void ) 
{
	...
	float dy = 0.1	+gl_FragCoord.y-resolution.y/2.0;
	...
	float red = (64.0 - sin(ang + md*3.141592*2.0) * 127.0)*(1.0-ds);
	float green = (64.0 - cos(ang + md*3.141592*2.0) * 127.0)*(1.0-ds);
	float blue = (192.0 + sin(ang  + md*3.141592*2.0) * 127.0)*(1.0-ds);
