...
void main() 
{
	...
	mouse.x=sin(time*0.001+1.)*0.1+cos(time*.0015+1.)*.1+nrand3(vec2(sin(time*0.000001),cos(time*0.00001))).x*0.0002+.4;
	mouse.y=sin(time*0.001+1.)*0.1+cos(time*.0014+1.)*.1+nrand3(vec2(sin(time*0.000003),cos(time*0.00002))).y*0.0002+.4;
