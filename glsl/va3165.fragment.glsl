...
//porting to QC by george toledo, then some tweaks on random func by psonice to get rid of abberant dots, then some more tweaks to get rid of vertex shader dependencies and transfer to webGL, george toledo.
//view on 1 res for snazziness, dithering will look better. Leaving remnants from original commented out.
//"from"porting GLSL by kioku based on syoyo's AS3 Ambient Occlusion
