...
void main( void ) 
{
	...
	float d = cos(length(m - p)*18.0);
	d = min(d, cos(length(p0 - p)*18.0));
	d = min(d, cos(length(p1 - p)*18.0));
	d = min(d, cos(length(p2 - p)*18.0));
	d = min(d, cos(length(p3 - p)*18.0));
	d = min(d, cos(length(p4 - p)*18.0));
	d = min(d, cos(length(p5 - p)*18.0));
	d = min(d, cos(length(p6 - p)*18.0));
	d = min(d, cos(length(p7 - p)*18.0));
	d = min(d, cos(length(p8 - p)*18.0));
	d = min(d, cos(length(p9 - p)*18.0));
	d = min(d, cos(length(p10 - p)*18.0));
	d = min(d, cos(length(p11 - p)*18.0));
	d = min(d, cos(length(p12 - p)*18.0));
	d = min(d, cos(length(p13 - p)*18.0));
	d = min(d, cos(length(p14 - p)*18.0));
	d = min(d, cos(length(p15 - p)*18.0));
	d = min(d, cos(length(p16 - p)*18.0));
	d = min(d, cos(length(p17 - p)*18.0));
	d = min(d, cos(length(p18 - p)*18.0));
	d = min(d, cos(length(p19 - p)*18.0));
	d = min(d, cos(length(p20 - p)*18.0));
	d = min(d, cos(length(p21 - p)*18.0));
	d = min(d, cos(length(p22 - p)*18.0));
	d = min(d, cos(length(p23 - p)*18.0));
	d = min(d, cos(length(p24 - p)*18.0));
	d = min(d, cos(length(p25 - p)*18.0));
	d = min(d, cos(length(p26 - p)*18.0));
	d = min(d, cos(length(p27 - p)*18.0));
	d = min(d, cos(length(p28 - p)*18.0));
	d = min(d, cos(length(p29 - p)*18.0));
	d = min(d, cos(length(p30 - p)*18.0));
	d = min(d, cos(length(p31 - p)*18.0));
