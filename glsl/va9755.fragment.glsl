...
const int   complexity      = 80;    // More points of color.
const float mouse_factor    = 245.0;  // Makes it more/less jumpy.
const float mouse_offset    = 4.0;   // Drives complexity in the amount of curls/cuves.  Zero is a single whirlpool.
const float fluid_speed     = 8.0;  // Drives speed, higher number will make it slower.
