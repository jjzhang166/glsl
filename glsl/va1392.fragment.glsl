...
void main( void ) {
	...
	vec3 color = 	mix(vec3(0.1, 0.3, 0.5), 	vec3(5.1, 0.5, 0.2),  pow(a, 0.2)) * 3.;
	color += 	mix(vec3(0.8, 0.2, 1.0), 	vec3(0.1, 0.5, 0.2),  pow(b, 0.1)) * 0.75;
	color += 	mix(c2, 			vec3(0.1, 0.5, 0.2),  pow(c, 0.1)) * 0.75;
