...
// forked to tweak numbers; less jumpy, but smoother at cost of quality
...
{
    const int maxSteps = 64;  // WAS 128
    const float hitThreshold = 0.005; // WAS 0.001
    hit = false;
    vec3 pos = ro;
