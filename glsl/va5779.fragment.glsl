// by @bermarte
// Exploration of the parent code by Kaeltyk
#ifdef GL_ES
...
//thanx Syntopia & Kali
float R =1.05,G=1.05,B=3.5*sin(time/100.);
float JuliaX=0.09*mouse.x,JuliaY=1.05*mouse.y*sin(time/100.);
//cx=-0.5, cy=-0.5 :
float C=15.;//*sin(time);
