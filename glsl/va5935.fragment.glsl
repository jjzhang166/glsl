...
// Yeah, those mobile devices cheat. I know that at Geforce ULP
// (used inside Galaxy Tab 10.1n) offers just 16 bits (maybe even less) of floating
// point mantissa instead of the usual 24 bits, yours (Adreno graphics) is even worse:
// just 11 bits mantissa + 5 bits exponent.
