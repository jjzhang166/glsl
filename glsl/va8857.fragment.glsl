...
void main( void )
{
	...
	float t = time - dist * dist * -3.5;
					// camera	
	vec3 oeil=vec3(0.0,0.0,-.2);		
					// rotation de la camera	
	oeil=rotor(oeil, t/3.0);
	 				//direction
	oeil.x += sin(t*0.01436) * 500.0;
	oeil.y += cos(t*0.01) * 500.0;
	oeil.z += sin(t*0.01352) * 500.0;
	vec3 dirRayon=normalize(rotor(vec3(p.x,p.y,1.60), 1.0));
