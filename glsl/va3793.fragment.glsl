...
void main(void){
  ...
  vec3 prp=vec3(-sin(time*0.6)*8.0,-1,cos(time*0.3)*8.0); //Change camera path position here
  vec3 vrp=vec3(mix(prp.r,0.0, sin(time))); // vec3(0,0,0); //Change camere view here
