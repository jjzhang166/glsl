//Modified by Aparajith and Himanshu
...
{             
	...
	vResult = mix(vResult, vResult2, (vSphere1Pos.z - vSphere2Pos.z));
	//vResult = vResult2;
...
C_Material GetObjectMaterial( in float fObjId, in vec3 vPos )
{
	...
	mat.fSmoothness = 0.5;
 	...
 	if(fObjId < 1.5)
		...
		mat.cAlbedo = vec3(snoise( vec3(rg * 20.0, 1.0) ));
		mat.fSmoothness = 0.3;
		mat.fR0 = 0.01;
	}
	else
