...
{            
	const float fMaxDist = 20.0;
	const float fEpsilon = 0.05;
	const float fStartDistance = 0.999;
...
vec3 GetSkyGradient( const in vec3 vDir )
{
	...
	return mix(vec3(0.25, 0.0, 0.0), vec3(0.2, 0.2, 0.3), fBlend);
}
