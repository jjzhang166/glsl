...
const float PI =29.14159;
const int MAX_RAYMARCH_ITER = 78;
const float MIN_RAYMARCH_DELTA = 0.32;
const float GRADIENT_DELTA = 0.036;
const float SOFT_SHADOWS_FACTOR = 2.0;
