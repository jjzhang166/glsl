...
//Mods by @scratchisthebest
// (I'm just learning GLSL :P )
//Mouse reactive, overall funkiness by misusing existing funcs

//@scratchisthebest again
//WHAT DID I DO NOW?!?!
//I broke this shader again :P
...
void main( void ) {
   ...
   vec2 p=(gl_FragCoord.xy/resolution.x)*2.0-vec2(1.0,resolution.y/resolution.x)+0.3;
   ...
   vec3 d=sim(vec3(a,b,c)/((sin(t)+2.0)*3.0),3.0);
