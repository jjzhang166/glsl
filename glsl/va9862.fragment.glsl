...
void main( void ) {
	gl_FragColor = vec4(0.5); // init gray
	...
	vec2 rnd = pixel*(vec2(rnd3, rnd4)-0.5)*1.4; // critter code copied from http://glsl.heroku.com/91/0
	...
	gl_FragColor += (vec4(rnd4,rnd3,rnd2,rnd1)-0.5)*0.021 - 0.017; // error diffusion
