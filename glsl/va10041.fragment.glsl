...
void main( void )
{
	...
	// y = x^3
	drawFormula( y, (x/x)/x, res, vec3( 0.0, 2.0, 0.0 ) );//Yes, this formula is known as Complex Inifinity at x=0... That was just to test the code... This runs very well! Great author!
	// y = sqrt( x )
	drawFormula( y, sqrt(x), res, vec3( 0.0, 0.0, 1.0 ) );
	// x^2 + y^2 = 9
	drawFormula( x*x + y*y*0.35, 9.0, res*5.0, vec3( 0.0, 0.0, 0.0 ) );
