...
void main( void ) {
	...
	col+=texture2D(buff,pos + vec2(0.0001, 0.01));
	col+=texture2D(buff,pos + vec2(0.001, 0.001));
	col+=texture2D(buff,pos + vec2(0.01, 0.01));
	col+=texture2D(buff,pos + vec2(0.0005, 0.03));
	col *= 0.25;
