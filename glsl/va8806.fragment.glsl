...
#endif
// playing with geometry generating function
uniform float time;
uniform vec2 mouse;
...
void main( void )
{
    ...
    vec3 camPos = vec3(cos(time*2.0), sin(time*1.0), 1.5);
