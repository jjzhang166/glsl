...
void main( void ) {
	...
	float a = 0.5 + tan(uv.x * 3.1415926 * 2.0) * 15.3;
	float b = 0.5 + cos(uv.y * 3.1415926 * 12.0) * 0.3;
	float c = 0.5 + acos(tan(uv.z * 3.1415926 * 3.0)) * 0.5;
	float f = abs(acos(cos(time*2.0)));
	
	
	vec3 color = mix(vec3(1.0, 0.4, 12.0-f), vec3(0.5*f, 0, 0), pow(a, 0.2)) * 3.;
