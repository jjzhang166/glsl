...
void CalcPixelRandom()
{
	...
	vec4 s1 = sin(time * 0.3422 + gl_FragCoord.xxxx * vec4(324.324234, 563.324234, 657.324234, 764.324234)) * 543.3423;
	vec4 s2 = sin(time * 0.03422 + gl_FragCoord.yyyy * vec4(567.324234, 435.324234, 432.324234, 657.324234)) * 654.5423;
...
{          
	vec4 vResult = vec4(100.0, -1.0, 0.0, 0.0);
