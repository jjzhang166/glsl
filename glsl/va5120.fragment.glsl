...
vec4 shade(float d)
{	
	return mix(vec4(0.8, 0.8, 0.8, _Density), vec4(1, 1, 1, 0), smoothstep(0.5, 1.0, d));
}
...
void main(void)
{
	...
	gl_FragColor = mix(vec4(color,1.0),col, 0.5);
}