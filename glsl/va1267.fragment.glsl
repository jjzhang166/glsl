...
{
	return length(voxel + vec3(0.5)) >= 48.0 + sin(voxel.x*0.25)*4.0+sin(voxel.z*0.25)*4.0+sin(voxel.y*0.25)*4.0;
}
...
void main( void ) 
{
	...
	GetCameraRay(vec3(10.1*sin(time), -15.1, 10.1*cos(time)), vec3(0.0, -14.0, 0.0), currentRay);
