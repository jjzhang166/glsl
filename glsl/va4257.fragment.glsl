...
#define SINUSOID_SPD	0.8
//speed
const float speed = 0.5;
const float speed_x = 0.001;
const float speed_y = 0.8;
// geometry
const float intensity = 3.;
const int steps = 8;
const float frequency = 20.0;
const int angle = 37; // better when a prime
// reflection and emboss
const float delta = 80.;
const float intence = 500.0;
