...
const float refractionIndex = 1.0;	// 1 = just fog, 1.2 = lightweight glass (most interesting value IMO), 1.4 = glass, 2.4 = diamond, 100 = apparently static texture
...
void main( void ) {
	...
	gl_FragColor = vec4(pow(color,vec3(1.0/1.8)), 1.);
