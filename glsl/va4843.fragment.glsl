...
#define PI 3.1416
const vec3 SEA = vec3(0.0, 0.915, 0.94);
const vec3 SAND = vec3(0.6, 0.97, 0.955);
const vec3 GRASS = vec3(0.12, 0.97, 0.93);
const vec3 ICE = vec3(0.8, 0.99, 0.99);
...
void main( void ) {
	...
	vec2 p = (-1.0 + 10.0 * ((gl_FragCoord.xy) / resolution.xy));
