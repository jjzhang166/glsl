...
{
	vec2 vScreen=resolution;
	vec2 vVignette=(vPoint/vScreen)-0.5; //(vScreen*0.5);
...
void main(void)
{
	...
	gl_FragColor=vec4(getVignette(vPoint,fVignette,fRadius,cVignette,cColour),1.0);
}
