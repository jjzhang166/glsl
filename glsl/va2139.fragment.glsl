...
void main( void ) {
	...
	vec3 suncolor = (1.0 - max(0.0, middayperc)) * vec3(1.5, 1.2, middayperc + 0.5) + max(0.0, middayperc) * vec3(1.0, 0,1) * 4.0;
	vec3 skycolor = vec3(middayperc + 0.8, middayperc + 0.1, middayperc + 0.2);
