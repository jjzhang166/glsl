// Experiments by @thismatt based on @P_Malin's blank slate framework.
...
{          
	...
	vec4 vDistFloor2 = vec4(vPos.y + sin(vPos.x*0.4) * sin(vPos.x*1.+tt), 1.0, vPos.xz);
...
void main( void )
{
	...
	GetCameraRayLookat( vCameraPos, vec3(0.0, 1.0, 20.0), ray);
