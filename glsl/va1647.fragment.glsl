...
// What you see is a hyperbolic space filled with lots of planes.

// Different from the (euclidean) space you're used to going away from a plane in hyperbolic space will cause it to visually shrink to a
// circle that gets smaller and smaller as you move away farther and farther.

// This is based on my dodecahedron renderer 
