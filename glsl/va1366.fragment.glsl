...
vec4 perlin( void ) {
	...
	v +=  snoise(p / 64. + z + 0.15 * time * speed) /2.;
	v +=  snoise(p / 32. + z + 0.15 * time * speed) /4.;
	v +=  snoise(p / 16. + z + 0.15 * time * speed) /8.;
	v +=  snoise(p / 8. + z + 0.15 * time * speed) /16.;
	v +=  snoise(p / 4.+ z + 0.15 * time * speed) /32.;
	v +=  snoise(p / 2.+ z + 0.15 * time * speed) /64.;
	v +=  snoise(2.0*p + z + 0.15 * time * speed) /256.;
	v +=  snoise(4.0*p + z + 0.15 * time * speed) /512.;
	v = 0.5 * v + 1.5;
...
void main()
{
	...
	color = 1.5-sqrt(1.0-color); // while coding
