...
const vec3 color1 = vec3(0.001961,0.119608,0.166667);
const vec3 color2 = vec3(0.62,0.2,1.498039);
const vec3 color3 = vec3(2,5,1.164706);
const vec3 color4 = vec3(0.0,1,30);
void main() {
	vec2 q;
	vec2 r;
