...
void init_fonts()
{
	...
	font_a[0] = vec3(0.0, 1.0, 0.0);
	font_a[1] = vec3(1.0, 0.0, 1.0);
	font_a[2] = vec3(1.0, 1.0, 1.0);
	font_a[3] = vec3(1.0, 0.0, 1.0);
	...
	font_e[1] = vec3(1.0, 0.0, 0.0);
	font_e[2] = vec3(1.0, 1.0, 0.0);
	font_e[3] = vec3(1.0, 0.0, 0.0);
  ...
  font_o[0] = vec3(0.0, 1.0, 0.0);
	font_o[1] = vec3(1.0, 0.0, 1.0);
	font_o[2] = vec3(1.0, 0.0, 1.0);
	font_o[3] = vec3(1.0, 0.0, 1.0);
	font_o[4] = vec3(0.0, 1.0, 0.0);
	
	font_p[0] = vec3(1.0, 1.0, 0.0);
	font_p[1] = vec3(1.0, 0.0, 1.0);
	font_p[2] = vec3(1.0, 1.0, 0.0);
  ...
  font_q[0] = vec3(0.0, 1.0, 0.0);
	...
	font_r[0] = vec3(1.0, 1.0, 0.0);
	font_r[1] = vec3(1.0, 0.0, 1.0);
	font_r[2] = vec3(1.0, 1.0, 0.0);
	font_r[3] = vec3(1.0, 0.0, 1.0);
	font_r[4] = vec3(1.0, 0.0, 1.0);
	
	font_s[0] = vec3(0.0, 1.0, 1.0);
	font_s[1] = vec3(1.0, 0.0, 0.0);
	font_s[2] = vec3(1.0, 1.0, 1.0);
	font_s[3] = vec3(0.0, 0.0, 1.0);
	font_s[4] = vec3(1.0, 1.0, 0.0);
	...
	font_u[3] = vec3(1.0, 0.0, 1.0);
	font_u[4] = vec3(1.0, 1.0, 1.0);
...
float draw_font_block(vec2 pixel_position, vec2 font_position, vec2 size)
{
	float gradient = 0.0;

	vec2 centered_font_position = font_position;
	if (pixel_position.x >= centered_font_position.x && pixel_position.x < (centered_font_position.x + size.x) && 
	    pixel_position.y >= centered_font_position.y && pixel_position.y < (centered_font_position.y + size.y))
	{
		gradient = 1.0;
	}
...
void main( void ) {
	...
	float dispy = sin(pixel_position.x * 16.0 + 0.5 * time) * 0.1 + sin(pixel_position.x * 48.0 + 1.5 * time) * 0.025;
	...
	vec4 font_color = vec4(vec3(gradient * sin(pixel_position.y * 300.0 + 16.0 * time), gradient * sin(pixel_position.y * 200.0 + 32.0 * time), gradient * sin(pixel_position.y * 100.0 + 28.0 * time)), 1.0);
