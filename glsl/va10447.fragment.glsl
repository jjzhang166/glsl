...
float noise( in vec3 x )
{
    ...
    // Change the first argument of the step function to see the different "density layers" of the noise function
    return step((-cos(time) + 1.0)/2.0, mix(mix(mix( hash(n+  0.0), hash(n+  1.0),f.x),
