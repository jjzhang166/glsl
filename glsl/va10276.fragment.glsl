...
float rand(vec3 co){
    return fract(sin(dot(co ,vec3(12.9898,78.233 ,56.227))) * 43758.5453);
}
...
float noise(vec3 pos) {
	return sin(22.0*pos.x) + sin(29.0*pos.y) + sin(25.*pos.z);
}

vec3 v1 = vec3(1.,2.,3.);
vec3 v2 = vec3(1.2,-3.,2.1);
vec3 v3 = vec3(-2.2,-3.,0.7);
...
void main()
{
	...
	vec4 color = vec4(rand(r), dot(r,v2),  dot(r,v3) , 0.0);
