...
void main( void ) {
	...
	float color = 0.0;
	color += sin( position.x * cos( time / 95.0 ) * 10.0 ) + cos( position.y * cos( time / 15.0 ) * 10.0 );
	color += sin( position.y * sin( time / 20.0 ) * 20.0 ) + cos( position.x * sin( time / 25.0 ) * 40.0 );
	color += sin( position.x * sin( time / 1.0 ) * 10.0 ) + sin( position.y * sin( time / 15.0 ) * 80.0 );
	color *= sin( time / 10.0 ) * 0.5;

	gl_FragColor = vec4( vec3( color, color * 0.5, sin( color + time / 3.0 ) * 0.05 ), 1.0 );
