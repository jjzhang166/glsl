// Very sorry for this offtopic, forgive me guys, but I want to thank you very, very much, Kabuto, for your tips.
// Could you write to me (logos7(a.t.)o2.pl) to obtain your e-mail adress? I would like to ask you something.
...
vec3 Forest(vec3 p, float spacing) {

	vec3 forest = mod(p, spacing);								// WHY DO I ONLY GET HALF A TREE?
...
void main(void){
  ...
  //Raymarching
	...
	const float MAX_DEPTH=16.0;								// Distance from camera that we will count as a miss
	const int MAX_STEPS = 80;								// Maxmimum amount of ray marching steps before counting the ray as a miss
