...
void main(void)
{
    ...
    vec3 campos = vec3(10000.0 * cos(t) , 30000.0 * sin(t) + 60000.0,  100.0 * sin(t*0.6) + (time*1000.0));
    vec3 raydir = normalize(vec3(0.0,-0.05,1.0));
    ...
    vec3 col = vec3(0.0,0.3*abs(n.x),0.2*abs(n.z)) + (bumb*n.x*n.z*0.3);          
