...
vec3 deform( in vec2 p )
{
    ...
    return texture2D(tex0,uv*.1).xyz;
}
...
void main( void ) {
	...
	float color = 20.0;
	color += sin( position.x * cos( time / 5.0 ) * 280.0 ) + cos( position.y * cos( time / 15.0 ) * 10.0 );
	color += sin( position.y * sin( time / 10.0 ) * 111.0 ) + cos( position.x * sin( time / 25.0 ) * 40.0 );
