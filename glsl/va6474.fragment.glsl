...
hairColor0 = rgb(0, 200, 234);
hairColor1 = rgb(0, 135, 192);
hairColor2 = rgb(0, 103, 151);
faceColor0 = rgb(247, 223, 204);
faceColor1 = rgb(209, 173, 159);
faceColor2 = rgb(183, 148, 133);
eyeColor0 = rgb(145, 164, 176);
eyeColor1 = rgb(207, 216, 218);
eyeColor2 = rgb(255, 255, 255);
eyeColor3 = rgb(0, 0, 0);
eyeColor4 = hairColor0;
eyeColor5 = hairColor2;
eyeColor6 = hairColor1;
mouthColor0 = rgb(78, 53, 40);
mouthColor1 = rgb(152, 78, 69);
mouthColor2 = rgb(170, 92, 83);
backgroundColor = rgb(51, 124, 221);
...
vec2 morph(vec2 pos) {
	return pos+sin(time+pos*1337.)*.03;
}
	

float circle(vec2 centre, float radius) {
  return distance(morph(centre), position()) - radius;
}
