...
void main( void ) {
	...
	float di = sin(0.25) * 5.0;
	if(di < 0.0) di  *= -1.0; 
	di += 1.0;
	
	sphere[0].c 	= vec3((mouse.x - 0.5) * 8.0, mouse.y * 4.0, -3.0);
	sphere[0].r	= 0.5;
	sphere[0].col	= vec3(1.0, 1.0, 1.0);
	
	sphere[1].c	= vec3(sin(0.0) * di, 0.0, cos(0.0) * di -3.0);
	sphere[1].r	= 0.5;
	sphere[1].col	= vec3(1.0, 0.3, 0.3);
	
	sphere[2].c	= vec3(sin(1.05) * di, 0.0, cos(1.05) * di -3.0);
	sphere[2].r	= 0.5;
	sphere[2].col	= vec3(1.0, 1.0, 0.3);
	
	sphere[3].c	= vec3(sin(2.1) * di, 0.0, cos(2.1) * di -3.0);
	sphere[3].r	= 0.5;
	sphere[3].col	= vec3(0.3, 1.0, 0.3);

	sphere[4].c	= vec3(sin(3.15) * di, 0.0, cos(3.15) * di-3.0);
	sphere[4].r	= 0.5;
	sphere[4].col	= vec3(0.3, 1.0, 1.0);
	
	sphere[5].c	= vec3(sin(4.2) * di, 0.0, cos(4.2) * di -3.0);
	sphere[5].r	= 0.5;
	sphere[5].col	= vec3(0.3, 0.3, 1.0);
	
	sphere[6].c	= vec3(sin(5.25) * di, 0.0, cos(5.25) * di -3.0);
	sphere[6].r	= 0.5;
