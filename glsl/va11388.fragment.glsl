...
//4d modulus rotation space - practicing =)
//had to adjust for aiolas laptop... wasnt working?
...
#define iter  	64
#define bound  	128.
#define epsilon vec4(0.1, 0., 0., 0.0)
...
void main( void ) {
	...
	r.o = vec4(0., 0., -3., -3.);
	r.p = r.o;
	r.d = normalize(vec4(p, 1., 1.));
	
	
	rotate ( time * .01 ,.0, 1.0, .0, 1.0 );
