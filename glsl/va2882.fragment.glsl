...
float b = 1.; // Affects amount of noisy areas.
float c = 3.; // Affects the size of the "bubbles."
...
void main( void ) {
	...
	if(HSL){
	  ...
	  pixel = HSLToRGB(vec3(angle * 0.02 + 0.05, mag/colorscale, mag/colorscale*.5));
	} else {
