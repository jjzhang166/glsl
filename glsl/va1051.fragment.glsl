...
void main( void )
{
	vec2 mid = (resolution / 2.0) + vec2(cos(time * 2.0) * 160.0, sin(time * 2.0) * 160.0);
	...
	else if(inCircle(gl_FragCoord.xy, mid, 220.0) && gl_FragCoord.y < mid.y - 140.0) gl_FragColor = vec4(0.5, 0.5, 0.5, 1.0);
	else if(inCircle(gl_FragCoord.xy, mid - vec2(108.0, 160.0), 64.0) && gl_FragCoord.y >= mid.y - 140.0) gl_FragColor = vec4(0.5, 0.5, 0.5, 1.0);
	else if(inCircle(gl_FragCoord.xy, mid - vec2(-40.0, 160.0), 130.0) && gl_FragCoord.y >= mid.y - 140.0) gl_FragColor = vec4(0.5, 0.5, 0.5, 1.0);
	else if(inCircle(gl_FragCoord.xy, mid, 220.0) && gl_FragCoord.y < mid.y) gl_FragColor = vec4(1.0, 0.0, 0.0, 1.0);
	else if(inCircle(gl_FragCoord.xy, mid, 220.0)) gl_FragColor = vec4(0.5, 0.5, 0.5, 1.0);
