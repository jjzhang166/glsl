...
float f(vec3 o){	
	float a=fract(sin(o.x)*sin(o.y))*.1;
	o=vec3(cos(a)*o.x*cos(a)*o.y,sin(a)*o.x*sin(a)*o.y,cos(sqrt(a)*o.x*cos(a)*o.y))*(sin(a)*o.x/cos(a)*o.y);
...
void main(){
	...
	gl_FragColor=vec4(s(vec3(cos(time*3.1)*2.1,sin(time*1.5)*1.2,1.0+sin(time)), 
